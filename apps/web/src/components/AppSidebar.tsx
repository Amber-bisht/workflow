...
export default function AppSidebar({ activePath, onNewWorkflow }: AppSidebarProps) {
  ...
  return (
    <aside
      className={`h-full bg-black border-r border-white/10 flex flex-col justify-between p-4 transition-all duration-300 z-30 shrink-0 ${
    ...
    >
      ...
      <div className="flex flex-col gap-5 w-full">
        <div className="flex items-center justify-between w-full">
          {!isCollapsed && (
            <Link href="/" className="flex items-center gap-2 overflow-hidden min-w-0">
              ...
              <span className="font-bold text-xs tracking-tight text-white font-mono truncate">
          ...
          <button
            ...
            className="p-1.5 text-neutral-400 hover:text-white hover:bg-white/10 rounded-lg transition-colors border border-white/10 bg-neutral-900 cursor-pointer shrink-0"
        ...
        <nav className="flex flex-col gap-1 w-full">
          <button
            ...
            className={`flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white text-black font-semibold text-xs hover:bg-neutral-200 transition-all cursor-pointer w-full shadow-sm ${
      ...
      <div className="flex flex-col gap-3 w-full border-t border-white/10 pt-3">
        {isCollapsed ? (
          ...
          <Link
            href="/profile"
            className={`flex items-center justify-between w-full p-1.5 rounded-xl hover:bg-white/5 transition-colors cursor-pointer group ${
